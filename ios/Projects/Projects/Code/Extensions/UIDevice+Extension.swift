...
extension UIDevice {
    ...
    static var allowEditor: Bool {
        if UIDevice.phone {
            return UIDevice.current.deviceType.rawValue > DeviceType.iPhone4S.rawValue
        } else if UIDevice.pad {
            return UIDevice.current.deviceType.rawValue > DeviceType.iPad3.rawValue
        }
...
public enum DeviceType: Int, EnumProtocol {
    case iPhone2G
    case iPhone3G
    case iPhone3GS
    case iPhone4
